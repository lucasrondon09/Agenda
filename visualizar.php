            ...
            if($query_rows > 0){
                while($dados = mysqli_fetch_array($query)){
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                        <input type="text" readonly class="form-control-plaintext" id="id" value="'.$id.'">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="staticEmail" class="col-sm-2 col-form-label">Nome</label>
                        <div class="col-sm-10">
                        <input type="text" readonly class="form-control-plaintext" id="nome" value="'.$nome.'">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="staticEmail" class="col-sm-2 col-form-label">Sobrenome</label>
                        <div class="col-sm-10">
                        <input type="text" readonly class="form-control-plaintext" id="sobrenome" value="'.$sobrenome.'">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="staticEmail" class="col-sm-2 col-form-label">Telefone</label>
                        <div class="col-sm-10">
                        <input type="text" readonly class="form-control-plaintext" id="telefone" value="'.$telefone.'">
                        </div>
                    </div>
                    <div class="form-group row">
